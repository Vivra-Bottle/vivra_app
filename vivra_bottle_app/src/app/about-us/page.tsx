    ...
    <div>
      <Stack display="Flex" mt={59} mb={59}>
        ...
        <Stack className={classes.about}>
          ...
          <Text>
            Vivra was born from a mutual concern over water quality and
            hydration levels in everyday life. We are a team of driven and
            innovative 4th-year students from the University of Waterloo&apos;s
            Faculty of Nanotechnology Engineering, collectively bringing eight
            years of industry experience.
          </Text>
          <Text>
            Our mission is to promote health and well-being through proper
            hydration practices, addressing both water quality and consumption.
            We are currently designing and fabricating a smart water bottle that
            leverages advanced sensor technology—down to the nanoscale—to
            monitor both water quality and consumption.
          </Text>
          <Text>
